...
class ComponentSearchBar extends StatefulWidget {
	...
	ComponentSearchBar({Key key, AsyncSnapshot<ModelsNewsList> snapshot, this.callBack, this.content}) : super(key: key);

	_ComponentSearchBarState createState() => _ComponentSearchBarState(callBack: this.callBack, content: this.content);
}

class _ComponentSearchBarState extends State<ComponentSearchBar> with CommonNavigator {
	...
	_ComponentSearchBarState({ dynamic callBack, String content}): super() {

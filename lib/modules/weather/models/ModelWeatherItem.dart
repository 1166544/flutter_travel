...
import 'package:flutter_travel/modules/weather/view/components/ComponentWeatherIconMapper.dart';
...
class ModelWeatherItem {
  ...
  List<ModelWeatherItem> forecast;
  ...
  static ModelWeatherItem fromJson(Map<String, dynamic> json) {
    final weather = json['weather'][0];
    return ModelWeatherItem(
      id: weather['id'],
      time: json['dt'],
  ...
  static List<ModelWeatherItem> fromForecastJson(Map<String, dynamic> json) {
    final weathers = List<ModelWeatherItem>();
    for (final item in json['list']) {
      weathers.add(ModelWeatherItem(
          time: item['dt'],

...
class ServiceBing extends HttpServiceCore {
	...
	Future<Response<dynamic>> getSplashImage(dynamic params) async {
		Response response = await this.get('HPImageArchive.aspx?format=js&idx=0&n=1&nc=${new DateTime.now().millisecondsSinceEpoch}&pid=hp&uhd=1&uhdwidth=375&uhdheight=812');
		return response;
	}
}

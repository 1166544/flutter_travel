...
class _CirclerState extends State<PageCircler> {
			...
			children: <Widget>[
				...
				Padding(
					...
					child: Column(
						crossAxisAlignment: CrossAxisAlignment.start,
						children: <Widget>[
							Text('Experiences', style: TextStyle(fontSize: 27.0, fontWeight: FontWeight.bold)),
							SizedBox(height: 20.0),
							Column(
								children: <Widget>[
									this.buildExperienceItem(
										'assets/chris.jpg', 'assets/p1.jpg',
										'assets/p2.jpg',
										124, 12,
										'Hiking in San Diego', 'The key is the childAspectRatio. This value is use to determine the layout in GridView. In order to get the desired aspect you have to set it to the (itemWidth / itemHeight). The solution would be this:'),
									...
									this.buildExperienceItem(
										...
										'assets/p2.jpg',
										80, 22,
										'How to offset a scaffold widget in Flutter?', "I did the first 3 steps. I have problems with the fourth one. I set an Offset state variable and placed my scaffold widget within a Positioned widget. I set the 'left' of the Positioned class to Offset.dx."),
									SizedBox(height: 30.0),
									this.buildExperienceItem(
										'assets/p5.jpg',
										'assets/p6.jpg',
										'assets/p2.jpg',
										468, 85,
										'The 2019 Stack Overflow Developer Survey Results Are In', 'So after some research, I found this wonderful video on youtube. Very informative and exactly solves my problem.'),
								],
							)
						],
					),
  ...
  /// 构建留言区
  Widget buildExperienceItem(String avataUrl, String chapter1Url, String chapter2Url, int chatNum, int favNum, String chatTitle, String chatDesc) {
	  return Column(
		  children: <Widget>[
			  	// 第1行 标题
				Row(
						...
						Column(
							children: <Widget>[
								Container(
									...
									child: Text(chatTitle, maxLines: 2, softWrap: true, style: TextStyle(fontSize: 20.0, color: Colors.black87.withOpacity(0.5), fontWeight: FontWeight.bold)),
								),
								SizedBox(height: 10.0),
								Container(
									width: MediaQuery.of(context).size.width - 100,
									child: Text(chatDesc, maxLines: 5, softWrap: true, style: TextStyle(fontSize: 14.0)),
								),
							],
						)
					],
				...
				Padding(
					...
					child: Row(
						children: <Widget>[
							...
							SizedBox(width: 10.0),
							Text(chatNum.toString(), style: TextStyle(color: Colors.grey, fontSize: 18.0)),
							Spacer(),
							CircleAvatar(
							...
							Container(
								...
								decoration: BoxDecoration(
									...
									gradient: RadialGradient(
										...
										radius: 0.7,
										colors: [Colors.blueAccent.withOpacity(0.5), Colors.blue],
										stops: [0.0, 0.99]
									),
									shape: BoxShape.rectangle
								),
								child: Center(
									child: Text(favNum.toString(), style: TextStyle(fontSize: 18.0, fontWeight: FontWeight.bold, color: Colors.white)),
								),
							)
						],
					),

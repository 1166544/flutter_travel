...
class TempagePageCopy extends StatefulWidget {
  final Widget child;

  TempagePageCopy({Key key, this.child}) : super(key: key);

  _TempagePageCopyState createState() => _TempagePageCopyState();
}

/// 首页面内容
class _TempagePageCopyState extends State<TempagePageCopy> with CommonTravelItem, CommonNavigator {
	...
	return ListView(
      ...
      return Padding(
          ...
          IconButton(
			  ...
			  onPressed: (){
				  // 跳转到详情页
				  this.navigateTo(context, new NoticePage());
			  }
		  ),
          SizedBox(width: 5.0),
					// 自定义按钮
          InkWell(
            ...
            onTap: () {
              this.navigateTo(context, new ProfilePage());
            },
          )
			  ],
		  ),
				  ...
				  children: <Widget>[
					...
					IconButton(
						...
						onPressed: (){
							Navigator.push(
								context,
								MaterialPageRoute(builder: (context) => OrderPageView())
							);
						},
					)
				  ],

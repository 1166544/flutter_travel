...
class _NoticePageState extends State<NoticePage> with CommonNavigator {
  ...
  Widget buildNotifcationList() {
	  List<NoticePageVO> subList = [
		  ...
		  new NoticePageVO(subTitle: 'Coming from another platform', description: "Check out: Android, iOS, Web, React Native, Xamarin.Forms"),
		  new NoticePageVO(subTitle: 'A tour of the Flutter', description: "Bookmark the API reference docs for the Flutter framework."),
		  new NoticePageVO(subTitle: 'FAQ', description: "Learn how to create layouts in Flutter, where everything is a widget."),
	  ];
	  ...
	  List<NoticeReadVO> readList = [
		  ...
		  new NoticeReadVO(dateTitle: 'Sat 20, May', readList: subList),
	  ];
